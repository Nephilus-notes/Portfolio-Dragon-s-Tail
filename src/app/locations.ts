...
export const LOCATIONS: Location[] = [
    { id: "T", name: "Town", enterText: "Here we are in town", exitText: "", options:["B", "A", "I", "U", "S"], enemies: []},
    { id: "B", name: "Blacksmith's Shop", enterText: `You step into a shop with black and silver shining at you from all around as arms and armor coat the walls.
    The blacksmith's face shines at you from over the counter.`, exitText: "", options:["T", "O"], enemies: []},
    ...
    { id: "P", name: `{character.name}'s Respite`, enterText: "Enjoying a Brief Respite", exitText: "", options:["T", "TTD"], enemies: []},
