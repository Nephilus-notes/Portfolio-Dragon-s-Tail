...
export const LOCATIONS: Location[] = [
    ...
    { id: "loc_UB_TH", name: "Thagrag's Hope", enterText: "", exitText: "", options:[""], enemies: []},
    { id: "loc_UB_WD", name: "Web of Depths", enterText: "", exitText: "", options:[""], enemies: []},
    { id: "loc_UB_GG", name: "Graith's Grotto", enterText: "", exitText: "", options:[""], enemies: []},
